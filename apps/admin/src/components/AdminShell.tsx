...
const groups: Array<{ label: string; items: NavItem[] }> = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: 'Photo review', href: '/photos', permission: 'verification.review', icon: ImageIcon },
      { label: 'Profile review', href: '/profiles', permission: 'verification.review', icon: UserCheck },
